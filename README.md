...
1. [Introduction to DashMed](#introduction-to-dashmed)<br>
    1.1. [Repository Components](#repository-components)<br>
2. [Subpackages & Modules](#subpackages-&-modules)<br>
    2.1. [The `sqlite` Module](#the-sqlite-module)<br>
    2.2. [The `role` Module](#the-role-module)<br>
    2.3. [The `display` Module](#the-display-module)<br>
    2.4. [The `bpgraph` Module](#the-bpgraph-module)<br>
3. [How to Use DashMed](#user-guide)<br>
4. [Extensions](#extensions)<br>
***
...
7. Afterwards, the same set of options will show up. Now that we have user, we can login! It will ask you to enter in your name and password to login.
![Alt text](/README_images/image-8.png)
![Alt text](/README_images/image-9.png)
Once again, you will have to enter in the admin password.
![Alt text](/README_images/image-10.png)

8. Another set of options will pop up. We can enter in '1' to view a patient dashboard.
![Alt text](/README_images/imageu.png)
The program will prompt for a patient ID. Let's use **23989**. Now we can view the patient dashboard and we have permission to do so as admin.
...
2. Let's try to view the patient dashboard for patient **97021**.
![Alt text](/README_images/image-17.png)
We can see that access was denied since scribes are not permitted to view the dashboards.
